...
1) Soil bulk density will be used to evaluate porosity.
2) Soil texture will be measued using a hydrometer.
3) Soil chemical properties (total C, N, P) will be outsourced to Colorado State University.
4) Soil microbial community will be measured by sequencing a small sample (stored in 95% ethanol) of each soil core using standard universal microbial primers (16S and ITS) in an Illumina HiSeq.
